...
const ClientPage = () => {
  ...
  const [setSelectedClient, setSelectedClient] = useState(null);
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      switch (searchType) {
        case "name":
          result = await clientApi.getClientByName(searchTerm);
          console.log("Name search result:", result);
          break;
        case "phone":
          result = await clientApi.getClientByPhoneNumber(searchTerm);
          console.log("Phone search result:", result);
          break;
        case "email":
          result = await clientApi.getClientByEmail(searchTerm);
  ...
  return (
    <div className="container" style={{ padding: "2rem" }}>
      <div className="dashboard-header">
        ...
        <p className="dashboard-subtitle">Manage your event clients</p>
